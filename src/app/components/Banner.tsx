    ...
    return (
        <div className="p-10 bg-[#1f54f4] rounded-xl flex flex-col items-center text-center text-white mb-4">
            ...
            {/* <a href="https://accounts.coinbase.com/signup" target="_blanc"> */}
                <button onClick={handleTest} className="flex bg-white text-black rounded-xl py-3 px-4 mt-4 font-semibold text-sm hover:bg-gray-300 hover:scale-110 duration-200 easy-in-out"> 
