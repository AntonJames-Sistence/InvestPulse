...
export const keyEvents = [
    {
        title: 'Bitcoin Halving Event (2020)',
        description: 'The Bitcoin halving event, which occurs approximately every four years, involves the reduction in the rewards given to Bitcoin miners for validating transactions. This mechanism is designed to control the supply of Bitcoin and maintain its scarcity over time, ultimately impacting its price and market dynamics.',
        icon: <HiOutlineNewspaper />,
        color: 'blue',
    },
    {
        title: 'Elon Musk Tweets (2021)',
        description: 'Elon Musk, the CEO of Tesla and SpaceX, has been known to influence cryptocurrency markets through his tweets. Musk\'s tweets about Bitcoin and other cryptocurrencies have sparked both positive and negative reactions, leading to significant price fluctuations.',
        icon: <FaArrowTrendUp />,
        color: 'green',
    },
    // {
